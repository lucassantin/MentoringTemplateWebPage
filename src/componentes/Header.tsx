...
export function Header() {
    return (
        ...
        items-baseline h-[10vh] w-[100%] pt-5 pr-12 pb-0 pl-8  ">
            <div>
                <p className="text-4xl font-bold cursor-pointer">Sandra Mara</p>
            </div>

            <div>
                <ul className="flex flex-row text-sm font-medium list-none gap-16 cursor-pointer ">
                    <a>Home</a>
                    <a>Apresentação</a>
                    <a>Mentorias</a>
                    <a>Depoimentos</a>
